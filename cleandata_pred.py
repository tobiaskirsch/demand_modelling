...
def dump_clean_dataset(df):
    df.to_csv("dataset/final_dataset_pred.csv")

def run(args):
    coordinates = get_coordinates(args)
    final_datasets = Path(args.finaldata_pred)
...
if __name__ == "__main__":
    ...
    parser.add_argument('finaldata_pred',
    ...
    parser.add_argument('-lf', '--load_factor',
                        help='name for the load factor file', default="dataset/finallf_pred.csv")
